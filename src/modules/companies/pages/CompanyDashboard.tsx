          ...
          <div className="bg-slate-900 text-white rounded-none p-8 md:p-12 relative overflow-hidden border border-slate-800 shadow-none">
            ...
            <div className="relative z-10 space-y-6 max-w-xl">
              ...
              <p className="text-slate-300 text-xs font-medium leading-relaxed">
                Anda belum memiliki profil badan usaha yang terdaftar di database PANTAU LIMBAH. Daftarkan entitas usaha Anda sekarang untuk mulai mengajukan dokumen lingkungan (SPPL/UKL-UPL) dan mengakses layanan pengangkutan B3 daerah [3].
              </p>
              <div className="pt-2">
                <Button
