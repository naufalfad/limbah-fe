...
interface WasteLogbookFormProps {
    onSuccess?: () => void;
}

export default function WasteLogbookForm({ onSuccess }: WasteLogbookFormProps) {
    ...
    const handlePreSubmit = (e: React.FormEvent) => {
        ...
        // Smart EWS Anomaly Trigger: Volume > 100 memicu mode warning [3]
        if (volNum > 100) {
    ...
    return (
        <div className="font-sans text-left">
            {showAnomalyWarning ? (
                /* PANEL PERINGATAN ANOMALI EWS (TACTICAL RED WARNING) */
                <div className="space-y-6 py-2 animate-in zoom-in duration-300">
                    <div className="p-4 bg-rose-50 border border-rose-300 rounded-none flex items-start gap-4 text-rose-950">
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-[11px] font-medium leading-relaxed mt-2 text-rose-800">
                                ...
                                Sistem AI otomatis akan mengirimkan alarm bahaya serta mencatat log audit ketidakpatuhan ini ke database verifikator DLH [3].
                            </p>
                        </div>
                    </div>
