      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 border border-slate-200 rounded-none shadow-sm">
          <div>
            ...
            <p className="text-slate-500 text-[11px] font-semibold mt-1.5">Pendaftaran manual spasial & pemberkasan AMDAL terpadu DLH.</p>
          </div>
        </div>
                ...
                <div className="lg:col-span-5 space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <textarea
                      ...
                      value={form.address}
                      onChange={handleTextChange}
                      placeholder="Kawasan Industri Panyileukan KM 12, Bandung"
