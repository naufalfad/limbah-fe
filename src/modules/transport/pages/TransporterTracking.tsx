...
// REUSE: Mengimpor ekosistem GFW Paradigm terpusat
 ...
 * 1. Peta live tracking berada di dasar layar (Z-0) menangkap pergerakan simulator.
 * 2. Sidebar nempel di kiri, otomatis memunculkan icon truk taktis untuk membuka laci telemetri.
 * 3. Kecepatan, sisa jarak, pH, & suhu tangki terintegrasi di dalam laci kiri.
 */
export default function TransporterTracking() {
  const { fetchPickupRequests } = useSijagaStore();

  // Memastikan database manifest pengangkutan diambil saat masuk halaman ini
  useEffect(() => {
    fetchPickupRequests();
  }, [fetchPickupRequests]);

  return (
    // Memenuhi 100% viewport layar tanpa dibungkus DashboardLayout
    <main className="relative h-screen w-screen overflow-hidden bg-slate-50 font-sans text-slate-800 selection:bg-emerald-200 selection:text-emerald-900">
      ...
      {/* =====================================================================
          ...
          Berada di dasar (z-0), memproses simulasi rute GPS.
      ====================================================================== */}
      <TrackingMap />
      ...
      {/* =====================================================================
          ...
          z-40. Otomatis menampilkan icon Truk live tracking khusus Transporter.
      ====================================================================== */}
      <GisSidebar />
      ...
      {/* =====================================================================
          ...
          Posisinya diatur langsung di dalam komponen PanelOrchestrator, z-30.
      ====================================================================== */}
      <PanelOrchestrator />

      {/* =====================================================================
          LAYER 4: MAP HUD & CONTROLS (KANAN BAWAH)
          Zoom in/out kustom HUD spasial, z-30.
      ====================================================================== */}
      <MapHUD />
